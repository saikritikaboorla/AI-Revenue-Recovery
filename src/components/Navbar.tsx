...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b border-[#1E2A3A] bg-[#070A10]/80 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-950/50 border border-emerald-500/25 text-emerald-400">
              ...
              <span className="text-[10px] font-mono font-medium whitespace-nowrap">Agent Engine Live</span>
            </div>
        ...
        <div className="mx-4 mt-1 rounded-xl border border-[#1E2A3A] bg-[#0D1117]/95 backdrop-blur-md shadow-2xl overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#1E2A3A]">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-mono text-emerald-400">Agent Engine Live</span>
            </div>
          </div>
