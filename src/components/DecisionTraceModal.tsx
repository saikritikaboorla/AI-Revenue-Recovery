...
const SIMULATED_VOICE_PREVIEW = [
  ['Agent', 'Namaste! Aapka payment complete nahi hua. Main ek secure UPI link bhej raha hoon—kya aap abhi try karna chahenge?'],
  ['Customer', 'Haan, bhej dijiye.'],
  ['Agent', 'Bilkul. Link yahan hai. Payment hone ke baad confirmation automatically verify hoga.'],
] as const;
