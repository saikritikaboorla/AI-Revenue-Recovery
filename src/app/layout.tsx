...
export const metadata: Metadata = {
  title: "RecoverAI — AI-Governed Revenue Recovery Platform",
  description: "RecoverAI is an AI-governed closed-loop recovery prototype that detects revenue at risk, executes bounded interventions, and verifies recovered funds with auditable ledger proof. No live model call is made per case in this build.",
